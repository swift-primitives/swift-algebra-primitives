...
/// ```
extension Algebra {
    /// An additive abelian group and a multiplicative monoid linked by distributivity.
    @frozen
    public struct Ring<Element> {
        ...
        /// Creates a ring from its additive abelian group and multiplicative monoid.
        @inlinable
        public init(
