...
/// at compile time.
extension Algebra {
    /// A commutative additive monoid and a multiplicative monoid linked by distributivity and zero annihilation.
    @frozen
    public struct Semiring<Element> {
        ...
        /// Creates a semiring from its additive commutative monoid and multiplicative monoid.
        @inlinable
        public init(
