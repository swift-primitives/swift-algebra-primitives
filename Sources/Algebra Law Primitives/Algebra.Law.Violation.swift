...
extension Algebra.Law {
    /// A record of a law violation: the law name, the offending elements, and the unequal sides.
    @frozen
    public struct Violation<Element> {
        ...
        /// Creates a violation record from the law name, offending elements, and the two unequal sides.
        @inlinable
